...
--   /c storage.classes[2].full = 300   改某职业满级线；  /c storage.classes = nil  清空恢复默认。
...
--            groups 组——这就是这个职业的“完美追求”目标等级。full 越小越快满（基础职业 ~100，终极 ~1000）。
...
local DEFAULT_CLASSES = {
    ...
    {key = 'oilman', name = '石油工人', full = 150, starter = {
    ...
    {key = 'plumber', name = '管道工', full = 150, starter = {
    ...
    {key = 'uraniumminer', name = '铀矿工人', full = 300, starter = {
    ...
    {key = 'enricher', name = '铀离心浓缩工人', full = 300, starter = {
    ...
    {key = 'nuclearman', name = '核电工人', full = 300, starter = {
        ...
        {pack = 'chemical-science-pack', item = 'centrifuge',                 groups = 3}}},
    {key = 'recyclerman', name = '回收工人', full = 300, starter = {{item = 'recycler', count = 1}}, rewards = {
    ...
    {key = 'roboticist', name = '机械师', full = 200, starter = {
    ...
    {key = 'warehouser', name = '仓库管理员', full = 200, starter = {
    ...
    {key = 'guard', name = '守卫', full = 200, starter = {
    ...
    {key = 'gunner', name = '机枪手', full = 200, starter = {
        {item = 'submachine-gun', count = 1}, {item = 'firearm-magazine', groups = 1}}, rewards = {
        {pack = 'military-science-pack', item = 'firearm-magazine',         groups = 10},
        {pack = 'military-science-pack', item = 'piercing-rounds-magazine', groups = 10}}},
    {key = 'tanker', name = '坦克手', full = 200, starter = {
    ...
    {key = 'toolman', name = '工具人', full = 300, starter = {{item = 'toolbelt-equipment', count = 1}}, rewards = {
        {pack = 'agricultural-science-pack', item = 'toolbelt-equipment', groups = 5}}},
    {key = 'outfitter', name = '服装设计师', full = 300, starter = {
    ...
    {key = 'bugkeeper', name = '养虫人', full = 200, starter = {{item = 'pentapod-egg', count = 1}}, rewards = {
        {pack = 'agricultural-science-pack', item = 'raw-fish', groups = 10}}},
    {key = 'fisher', name = '渔夫', full = 200, starter = {
    ...
    {key = 'farmer', name = '农夫', full = 200, starter = {
    ...
    -- ── 科学/星球组（各星球招牌机器/材料；满级线 500，需对应瓶 100 级解锁）──
    {key = 'astronaut', name = '宇航专家', full = 500, starter = {
    ...
    {key = 'metallurgist', name = '冶金学家', full = 500, starter = {
    ...
    {key = 'electromancer', name = '电磁专家', full = 500, starter = {
    ...
    {key = 'biologist', name = '生物专家', full = 500, starter = {
    ...
    {key = 'physicist', name = '物理学家', full = 500, starter = {
    ...
    {key = 'astronomer', name = '天文学家', full = 500, starter = {
    ...
    {key = 'pilot', name = '飞船驾驶员', full = 500, starter = {
